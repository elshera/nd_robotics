...
def compute_color_histograms(cloud, nbins=32, using_hsv=False):
    ...
    # Replace normed_features with feature vector
    normed_features = create_hist(ch1=channel_1_vals, ch2=channel_2_vals, ch3=channel_3_vals, nbins=nbins)
...
def compute_normal_histograms(normal_cloud, nbins=32):
    ...
    normed_features = create_hist(ch1=norm_x_vals, ch2=norm_y_vals, ch3=norm_z_vals, nbins=nbins)
    return normed_features
